...
> 🍴 **这是一个 Fork**，基于 [lfenghx/skill_agent](https://github.com/lfenghx/skill_agent) 进行了深度改造和功能增强。感谢原作者的开源贡献！
...
- **GitHub:** [NumInvis](https://github.com/NumInvis) / [NumInvis/skill_agent](https://github.com/NumInvis/skill_agent)

**原作者（致敬）：**

- **GitHub:** [lfenghx](https://github.com/lfenghx) / [lfenghx/skill_agent](https://github.com/lfenghx/skill_agent)
- **Bilibili:** 元视界\_O凌枫o
